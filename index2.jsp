...
<body background="bg1.jpg">
    <div id="background">
        ...
        <div id="menu">
            <div id="logo"><b style="color:#2c7ad6 ;">BOOKSTORE</b>
            </div>
            <div id="menu1">
                <ul>
        ...
        <div id="slider">
            ...
            <div id="y">
                <div id="l">
                    <h1 style=" text-align: center; color: #2c7ad6;">LOGIN</h1>
                    <div id="student">
                    <form action="admin5.jsp" method="get">
                            USER NAME <br><input type="text" class="t" name="name"><br>
                            PASSWORD <br><input type="text"class="t"  name="password"/><br>
                            <a href="adminHome.jsp"><input type="submit" value="login" style="border: none;width: 103%; height: 30px; background-color: #2c7ad6;"></a>
                            <a href="#" style="color:blue; text-decoration: none;"><p >forget password</p></a>
                            <a href="user1.jsp">user login</a>
                  </form> </div>
                </div>
             </div>
